...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Calcx-Pro',
        short_name: 'Calcx-Pro',
        description:
          'A precision, production-grade professional engineering calculator with standard and scientific modes, unit conversions, and persistent history.',
        theme_color: '#090D16',
